#' Test reporter: Discover tests in 'testthat'.
#'
#' This reporter will output names and locations of tests. The names get parsed
#' from the 'description' argument in test_that()/describe()/it() calls.
#'
#' @export
DiscoverTestsReporter <- R6::R6Class("DiscoverTestsReporter",
  inherit = Reporter,
  private = list(
    filename = NULL
  ),
